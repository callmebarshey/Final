...
import com.example.assignment1.Adapter.ToDoAdapter;
public class EditItemActivity extends ItemTouchHelper.SimpleCallback {
    private ToDoAdapter adapter;

    public EditItemActivity(ToDoAdapter adapter) {
    ...
    public void onSwiped( final RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        if (direction == ItemTouchHelper.LEFT) {
            ...
            builder.setTitle("This will delete the task");
